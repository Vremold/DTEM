...
from utils import (GraphLoader, 
                   ...
                   l2_penalty,)
from model2 import (EdgeRegresionScorer)

SPECIAL_SUFFIX = "train_lp_hetsage_15_15_15_without_feature"
...
class ParameterNamespace():
    def __init__(self, special_suffix):
        ...
        self.graph_path = "GNN/DataPreprocess/full_graph/structure_graph_without_feature.bin"
        ...
        self.pretrain_model_path = "GNN/HetSAGE/pretrained/tech-free/model.bin"
...
def train(
    ...
    for epoch in tqdm(range(epochs)):
        ...
        b_idx = 0
        for er_batch in tqdm(er_dataloader, total=len(er_dataloader)):
            # Edge Regression
            er_loss = 0
            if er_batch:
                _, subgraph, blocks = er_batch
