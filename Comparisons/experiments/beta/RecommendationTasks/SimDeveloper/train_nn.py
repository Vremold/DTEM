...
if __name__ == "__main__":
    train_sample_path =     "Comparisons/experiments/beta/RecommendationTasks/SimDeveloper/data/train.json"
    valid_sample_path =     "Comparisons/experiments/beta/RecommendationTasks/SimDeveloper/data/valid.json"
    test_sample_path =      "Comparisons/experiments/beta/RecommendationTasks/SimDeveloper/data/test.json"
    model_path =            "Comparisons/model/beta/HetSAGE/SimDeveloper/model_with_watch_without_er.bin"
