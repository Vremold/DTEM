...
if __name__ == "__main__":
    train_sample_path =     "Comparisons/experiments/beta/RecommendationTasks/RepoMaintainer/data/train.json"
    valid_sample_path =     "Comparisons/experiments/beta/RecommendationTasks/RepoMaintainer/data/valid.json"
    test_sample_path =      "Comparisons/experiments/beta/RecommendationTasks/RepoMaintainer/data/test.json"
    model_path =            "Comparisons/model/beta/HetSAGE/RepoMaintainer/model_with_watch_without_er.bin"
