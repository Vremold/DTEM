...
if __name__ == "__main__":
    train_sample_path =     "Comparisons/experiments/beta/RecommendationTasks/PRReviewer/data/train.json"
    valid_sample_path =     "Comparisons/experiments/beta/RecommendationTasks/PRReviewer/data/valid.json"
    test_sample_path =      "Comparisons/experiments/beta/RecommendationTasks/PRReviewer/data/test.json"
    model_path =            "Comparisons/model/beta/HetSAGE/PRReviewer/model_with_watch_without_er.bin"
    
    node_embedding_path = "Comparisons/embedding/beta/HetSAGE/pretrained_node_embedding_with_watch.bin"
    ...
    valid_dataset = MyDataset(samples=valid_sample_path, repo_node_embedding=repo_node_embedding, pr_embedding=pr_node_embedding, contributor_embedding=contributor_node_embedding)
