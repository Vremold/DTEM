...
if __name__ == "__main__":
    train_sample_path =     "Comparisons/experiments/beta/RecommendationTasks/ContributionRepo/data/train.json"
    test_sample_path =      "Comparisons/experiments/beta/RecommendationTasks/ContributionRepo/data/test.json"
    eval_sample_path =      "Comparisons/experiments/beta/RecommendationTasks/ContributionRepo/data/valid.json"

    model_path = "Comparisons/model/beta/HetSAGE/ContributionRepo/model_pretrained_with_watch.bin"
