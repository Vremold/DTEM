...
SPECIAL_SUFFIX = "pretrain_with_all_features"
# wandb.init(
#     project="HetSAGE_pretrain_with_all_features_without_watch"
# )
...
class ParameterNamespace():
    def __init__(self, special_suffix):
        ...
        self.checkpoint_dir = f"Comparisons/experiments/beta/HetSAGE/checkpoint/{special_suffix}_{now}/"
        if not os.path.exists(self.checkpoint_dir):
            os.makedirs(self.checkpoint_dir)
        
        self.logger = None

        self.graph_path = "Comparisons/data/beta/structure_graph_with_node_feature_without_watch.bin"
