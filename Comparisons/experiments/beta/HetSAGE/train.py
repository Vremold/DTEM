...
SPECIAL_SUFFIX = "train_with_all_features_with_watch_15^3"
...
class ParameterNamespace():
    def __init__(self, special_suffix):
        ...
        self.graph_path = "Comparisons/data/beta/structure_graph_with_node_feature_with_watch.bin"
        ...
        self.pretrain_model_path = "Comparisons/model/beta/HetSAGE/pretrained/model_with_watch.bin"
...
def train(
    ...
    for epoch in tqdm(range(epochs)):
        ...
        b_idx = 0
        for er_batch in tqdm(er_dataloader):
            # Edge Regression
            er_loss = 0
            if er_batch:
                _, subgraph, blocks = er_batch
