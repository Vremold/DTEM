...
class ParameterNamespace():
    def __init__(self, special_suffix):
        ...
        self.trained_model_path = "Comparisons/model/beta/HetSAGE/pretrained/model_with_watch.bin"
        self.node_embedding_dir = "Comparisons/embedding/beta/HetSAGE/"
...
if __name__ == "__main__":
    ...
    torch.save(x, pn.node_embedding_dir + "pretrained_node_embedding_with_watch.bin")
