...
SPECIAL_SUFFIX = "pretrain_lp_ec_hgt_15_15_15"
...
class ParameterNamespace():
    def __init__(self, special_suffix):
        ...
        self.checkpoint_dir = f"Comparisons/experiments/beta/HGT/checkpoint/{special_suffix}_{now}/"
...
if __name__ == "__main__":
    ...
    model = HGT(
        ...
        hidden_size=pn.hidden_size,
        out_size=pn.out_feats,
    ...
    lp_scorer = LinkPredictionScorer(pn.hidden_size).to(pn.device)
