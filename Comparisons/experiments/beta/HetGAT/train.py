...
SPECIAL_SUFFIX = "train"
# wandb.init(
#     project="HetGAT_train"
# )
...
class ParameterNamespace():
    def __init__(self, special_suffix):
        ...
        self.checkpoint_dir = f"Comparisons/experiments/beta/HetGAT/checkpoint/{special_suffix}_{now}/"
        ...
        # Please replace this path with your own pretrained model path
        self.pretrain_model_path = "Comparisons/model/beta/HetGAT/pretrained/model.bin"
