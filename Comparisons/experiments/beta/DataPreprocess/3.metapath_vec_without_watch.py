...
if __name__ == "__main__":
    src_structure_graph = "Comparisons/data/beta/structure_graph_without_watch.bin"
    ...
    if not os.path.exists(dst_dir):
        os.makedirs(dst_dir)
    torch.save(node_embedding, os.path.join(dst_dir, "node_metapath_embedding_without_watch.bin"))