...
class GraphBuilder(object):
    ...
    def load_star_rels(self, hg_srcs:dict, reverse=False, contain_reverse=False):
        # watch_rels = set()
...
if __name__ == "__main__":
    ...
    gb.build_graph(dst_graph_path="Comparisons/data/beta/structure_graph_without_watch.bin")